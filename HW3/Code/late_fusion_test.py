...
files = ['Test_Final/Places', 'Test_Final/Resnet', 'Test_Final/MFCC']
...
model_file = 'LateFusion/Test/' + model_name + '.pickle'
...
fwrite1 = open('LateFusion/Files/Test/' + model_file.split('.')[0].split('/')[-1] + '+op0.txt', 'w')
fwrite2 = open('LateFusion/Files/Test/' + model_file.split('.')[0].split('/')[-1] + '+op1.txt', 'w')
fwrite3 = open('LateFusion/Files/Test/' + model_file.split('.')[0].split('/')[-1] + '+op2.txt', 'w')
fwrite4 = open('LateFusion/Files/Test/' + model_file.split('.')[0].split('/')[-1] + '+op3.txt', 'w')
