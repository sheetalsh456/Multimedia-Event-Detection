...
if __name__ == '__main__':
    ...
    video_vector_map = pickle.load(open(feat_dir+'features',"rb"))
    val_videos_file = open('/project/hsr/sshalini/LSMA/11775-hws/hw2_code/list/test.video', 'r')
    ...
    probs = svm_model.predict_proba(K)
    probs1 = probs[:,0]
    probs2 = probs[:,1]
    probs3 = probs[:,2]
