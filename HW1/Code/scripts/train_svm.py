...
if __name__ == '__main__':
    ...
    feat_dir = sys.argv[1] # kmeans folder
    feat_dim = int(sys.argv[3]) # no.of clusters = 50
    ...
    train_videos_file = open('/project/hsr/sshalini/LSMA/11775-hws/hw1_code/list/train', 'rb')
    val_videos_file = open('/project/hsr/sshalini/LSMA/11775-hws/hw1_code/list/val', 'rb')
...
# 
    ...
    cPickle.dump(clf, open(output_file, 'w+'))
