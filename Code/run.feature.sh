...
video_path=/data/VOL4/sshalini/data/speech-kitchen.org/sdalmia/11775_videos/video   # path to the directory containing all the videos. In this example setup, we are linking all the videos to "../video"
...
python scripts/select_frames.py list/train.video list/val.video 0.5 select.mfcc.csv || exit 1;
...
# echo "Creating vocab"
python scripts/create_asr_vocab.py list/all.video

# echo "Creating ASR features"
# mkdir -p asrfeat
python scripts/create_asrfeat.py asr_vocab_list list/all.video || exit 1; 
